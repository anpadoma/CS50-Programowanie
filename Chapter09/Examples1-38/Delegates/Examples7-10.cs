...
namespace Delegates
{
    ...
    class Examples7_10
    {
        public static void CreateDelegates()
        {
            ...
            Predicate<int> greaterThanZero = zeroThreshold.IsGreaterThen;
            Predicate<int> greaterThanTen = tenthreshold.IsGreaterThen;
            Predicate<int> greaterThanHundred = hundredThreshold.IsGreaterThen;

            //Listing 9-10
            Predicate<int> megaPredicate1 = greaterThanZero + greaterThanTen + greaterThanHundred;
